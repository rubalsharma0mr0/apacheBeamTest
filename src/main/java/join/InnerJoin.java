...
public class InnerJoin {
    public static void main(String[] args) {
        ...
        PCollection<KV<String, String>> pCollectionOrder =
                pipeline.apply(TextIO.read().from("/home/rubal/IdeaProjects/apacheBeam/Lib/Input/join/user_order.csv"))
                        .apply(ParDo.of(new OrderParsing()));
        PCollection<KV<String, String>> pCollectionUser =
                pipeline.apply(TextIO.read().from("/home/rubal/IdeaProjects/apacheBeam/Lib/Input/join/p_user.csv"))
        ...
        //combining tuple
        PCollection<KV<String, CoGbkResult>> tupleCollection =
                KeyedPCollectionTuple.of(orderTupleTag, pCollectionOrder).and(userTupleTag, pCollectionUser).apply(CoGroupByKey.create());
        ...
        applyOutput.apply(TextIO.write().to("/home/rubal/IdeaProjects/apacheBeam/Lib/Output/join.InnerJoin.csv").withHeader("Id,Order,User").withNumShards(1).withSuffix(".csv"));
